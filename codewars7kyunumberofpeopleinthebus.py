...
Take a look on the test cases: [get on the bus or add people, get off the bus or subtract people]
...
def number(bus_stops):
    peopleinbus = 0
    for eachstop in bus_stops:
        peopleinbus = peopleinbus + eachstop[0] - eachstop[1]
    print(peopleinbus)
